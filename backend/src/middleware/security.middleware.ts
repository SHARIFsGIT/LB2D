...
export const authRateLimit = rateLimit({
  ...
  maxRequests: 200, // 200 requests per 15 minutes for auth endpoints (much more lenient)
  message: 'Too many authentication attempts, please try again later'
});

export const apiRateLimit = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  maxRequests: 1000, // 1000 requests per 15 minutes for API endpoints
...
export const registerRateLimit = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  maxRequests: 10000, // 10,000 registration attempts per 15 minutes (essentially unlimited for development)
