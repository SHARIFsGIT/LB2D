...
const ResourceViewer: React.FC<ResourceViewerProps> = ({
  ...
  const handleDownload = () => {
    window.open(`${appConfig.api.baseUrl}/resources/${resource._id}/download`, '_blank');
  };
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      ...
      {resource.description && <p className="text-gray-700 mb-4">{resource.description}</p>}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-6xl max-h-[90vh] w-full overflow-hidden">
            ...
            <div className="p-4 overflow-auto max-h-[calc(90vh-100px)]">
              {resource.type === 'image' && (
                <img
                  src={`${appConfig.api.baseUrl}/resources/${resource._id}/view`}
                  alt={resource.title}
