      ...
      <section className="relative bg-cover bg-no-repeat text-white min-h-[580px] flex items-center" style={{backgroundImage: 'url(/hero-bg-without-text.png)', backgroundPosition: 'center 20%'}}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto">
            We&apos;re here to support your language journey every step of the way.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 md:mb-16">
            ...
            <Card className="text-center p-6 sm:p-8 sm:col-span-2 md:col-span-1">
              ...
              <Button className="bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold shadow-lg hover:shadow-xl hover:!bg-transparent transition-all text-sm sm:text-base min-h-[44px] px-4 sm:px-6">
                Join WhatsApp Group
              </Button>
            </Card>
          </div>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold shadow-lg hover:shadow-xl hover:!bg-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base min-h-[44px]"
                >
                ...
                {filteredFaqs.length === 0 ? (
                  <Card className="p-6 text-center">
                    ...
                    <Button
                      ...
                      className="mt-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg hover:shadow-xl hover:from-emerald-700 hover:to-teal-800 transition-all"
                    >
                      Clear Filters
                    </Button>
                  </Card>
