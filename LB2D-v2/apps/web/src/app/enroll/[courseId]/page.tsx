    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 p-4 sm:p-6 md:p-8">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-4">
                ...
                <button
                  ...
                  className={`px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold shadow-lg text-sm sm:text-base min-h-[44px] order-1 sm:order-2 transition-all duration-300 ${
      ...
      >
        {!process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY ? (
          <PaymentFallback message="Stripe is not configured. Please add NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY to your environment variables." />
        ) : clientSecret && course ? (
