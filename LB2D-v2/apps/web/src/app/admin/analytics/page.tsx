  ...
  const fetchStudentAnalytics = useCallback(async () => {
    try {
      ...
      const [testsRes, certificatesRes, paymentsRes, progressRes, studentsRes] =
        await Promise.all([
          fetch(
            `${appConfig.api.baseUrl}/analytics/student-results`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          ),
          fetch(
            `${appConfig.api.baseUrl}/analytics/student-certificates`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          ),
          fetch(
            `${appConfig.api.baseUrl}/analytics/student-payments`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          ),
          fetch(
            `${appConfig.api.baseUrl}/analytics/student-progress`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          ),
          fetch(
            `${appConfig.api.baseUrl}/analytics/recent-students?limit=20&showAllEnrolled=true`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          ),
  ...
  const fetchSupervisorAnalytics = useCallback(async () => {
    ...
    try {
      ...
      const [salaryRes, videosRes] = await Promise.all([
        fetch(
          `${appConfig.api.baseUrl}/analytics/supervisor-salary`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ),
        fetch(
          `${appConfig.api.baseUrl}/analytics/supervisor-videos`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ),
  ...
  const fetchAssessmentReports = useCallback(async () => {
    try {
      ...
      const [testsResponse, quizAttemptsResponse, enrollmentsResponse] = await Promise.all([
        fetch(
          `${appConfig.api.baseUrl}/tests/admin/reports?limit=200`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ),
        fetch(
          `${appConfig.api.baseUrl}/quizzes/admin/all-attempts`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ),
        fetch(
          `${appConfig.api.baseUrl}/enrollments`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        )
      ...
      const combinedData: any = { tests: [], quizzes: [], enrollments: [] };
...
// @ts-ignore - title can be undefined but we handle it
  ...
  const { isConnected, subscribe } = useWebSocket(); // Note: removed params
  ...
  }, [isConnected, subscribe, handleNotification]);
  ...
  const downloadTestPDF = async (testId: string) => {
    try {
      ...
      const response = await fetch(
        `${appConfig.api.baseUrl}/tests/admin/details/${testId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
...
Generated on: ${new Date().toLocaleString()}
  ...
  const handleStudentClick = async (student: any) => {
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/tests/admin/reports?userId=${student.id}&limit=100`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const executeClearPaymentData = async () => {
    ...
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/analytics/clear-payment-data`,
        {
          method: "DELETE",
          headers: {
  ...
  const executeClearTestData = async () => {
    ...
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/analytics/clear-test-data`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const executeInitializeSupervisorSalaries = async () => {
    ...
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/analytics/initialize-supervisor-salaries`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const executeClearSupervisorSalaryData = async () => {
    ...
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/analytics/clear-supervisor-salary`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const executePaySupervisor = async (supervisor: any, currentMonth: number, currentYear: number, selectedMethod: string) => {
      try {
        ...
        const response = await fetch(
          `${appConfig.api.baseUrl}/analytics/supervisor-payment`,
          {
            method: "POST",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleSalaryPaymentToggle = async (
    ...
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/analytics/supervisor-salary-payment`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const executeClearVideoAnalyticsData = async () => {
    ...
    try {
      const token = typeof window !== 'undefined' ? sessionStorage.getItem("accessToken") : null;
      const response = await fetch(
        `${appConfig.api.baseUrl}/analytics/clear-video-analytics`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
