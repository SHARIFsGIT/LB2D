...
function ResetPasswordContent() {
  ...
  const calculatePasswordStrength = (password: string): PasswordStrength => {
    ...
    const reversedLevels = [...strengthLevels].reverse();
    const strength = reversedLevels.find(level => score >= level.min) || { min: 0, label: 'Very Weak', color: 'red' };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-red-500 via-yellow-500 to-green-500 relative overflow-hidden px-4 sm:px-6">
        ...
        <div className="bg-white bg-opacity-60 backdrop-blur-md px-6 sm:px-8 md:px-10 py-6 rounded-3xl shadow-2xl w-full max-w-lg border border-white border-opacity-50 relative z-10 text-center">
          ...
          <Link href="/login" className="text-red-600 hover:underline font-semibold text-sm sm:text-base">
            Go to Login Now
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white bg-opacity-60 backdrop-blur-md px-6 sm:px-8 md:px-10 py-6 rounded-3xl shadow-2xl w-full max-w-lg border border-white border-opacity-50 relative z-10">
        ...
        {!token ? (
          <div className="text-center">
            ...
            <Link href="/forgot-password" className="text-purple-500 hover:underline font-semibold">
...
>
            ...
            >
              {/* Star 1 - Black */}
              <div className="fixed w-5 h-5 top-[10%] left-[5%] opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-50 transition-all duration-1200 ease-fluid pointer-events-none">
                <svg
              ...
              {/* Star 2 - Blue */}
              <div className="fixed w-3 h-3 top-[25%] left-[80%] opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-50 transition-all duration-900 ease-fluid pointer-events-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 784.11 815.53"
              ...
              {/* Star 3 - White */}
              <div className="fixed w-4 h-4 top-[5%] left-[50%] opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-50 transition-all duration-1400 ease-fluid pointer-events-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 784.11 815.53"
              ...
              {/* Star 4 - Orange */}
              <div className="fixed w-2 h-2 top-[40%] right-[10%] opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-50 transition-all duration-1000 ease-fluid pointer-events-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 784.11 815.53"
              ...
              {/* Star 5 - Cyan */}
              <div className="fixed w-3 h-3 top-[70%] left-[15%] opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-50 transition-all duration-1600 ease-fluid pointer-events-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 784.11 815.53"
        ...
        <div className="mt-6 text-center">
          <Link href="/login" className="text-red-600 hover:underline text-sm font-semibold">
            Back to Login
          </Link>
        </div>
      </div>
