      ...
      <section className="relative bg-cover bg-center bg-no-repeat text-white py-32" style={{backgroundImage: 'url(/hero-bg-without-text.png)', backgroundPosition: 'center 30%'}}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
            Connecting Bengali and German languages for European opportunities. <br />Discover our story and mission to empower Bengali speakers worldwide.
          </p>
          <div className="mt-8 flex justify-center space-x-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
              <span className="text-white font-semibold">Learn Our Story</span>
            </div>
          </div>
        </div>
      </section>
