          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              ...
              <p className="text-lg font-bold text-gray-900">
                {testHistory.length > 0 ? new Date(testHistory[testHistory.length - 1].createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : 'N/A'}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-xl font-bold text-gray-900">{Math.round((certificates.length / 6) * 100)}%</p>
              ...
              certificates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {certificates.map((cert) => (
                    ...
                    >
                      {/* Certificate Header */}
                      <div className={`${getLevelColor(cert.certificationLevel)} p-6 text-white`}>
                      ...
                      <div className="p-6">
                        <div className="text-center mb-4">
                          <div className="text-4xl font-bold text-gray-900 mb-2">{cert.score}%</div>
                          ...
                          <div className="bg-gray-50 rounded-lg p-3">
                            <div className="grid grid-cols-2 gap-3 text-xs">
                              <div>
                                ...
                                <p className="font-semibold text-gray-900">{new Date(cert.createdAt).toLocaleDateString()}</p>
                              </div>
                              <div>
                        ...
                        <div className="mt-4">
                          ...
                          >
                            {downloadingCert === cert._id ? 'Downloading...' : 'Download Certificate'}
                          </button>
                        </div>
                      </div>
                    </div>
