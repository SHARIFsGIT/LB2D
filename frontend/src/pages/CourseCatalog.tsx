...
const CourseCatalog: React.FC = () => {
  ...
  const levelDescriptions = {
    ...
    A2: "Elementary - Simple conversations and routine tasks",
    B1: "Intermediate - Main points on familiar matters",
    B2: "Upper Intermediate - Complex texts and spontaneous speech",
          ...
          {selectedLevel && (
            <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
              <p className="text-blue-800 font-medium text-center">
                ...
                {
                  levelDescriptions[
                    selectedLevel as keyof typeof levelDescriptions
                  ]
                }
              </p>
            </div>
