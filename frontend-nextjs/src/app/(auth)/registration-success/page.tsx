      ...
      <div className="bg-white bg-opacity-60 backdrop-blur-md px-6 sm:px-8 md:px-10 py-6 rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-lg border border-white border-opacity-50 relative z-10 text-center">
        ...
        <div className="space-y-3 mb-4 sm:mb-6">
          <button
            ...
            className="group relative w-full bg-gradient-to-r from-slate-800 to-gray-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl hover:from-slate-800 hover:to-gray-800 transition-all duration-3500 ease-smooth overflow-hidden text-sm sm:text-base min-h-[44px]"
          >
          ...
          <button
            onClick={() => router.push('/')}
            className="group relative w-full bg-gradient-to-r from-emerald-800 to-teal-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl hover:from-emerald-800 hover:to-teal-800 transition-all duration-3500 ease-smooth overflow-hidden text-sm sm:text-base min-h-[44px]"
          >
            {/* Back to Home Button Stars */}
            <div className="fixed w-4 h-4 top-[12%] left-[18%] opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-50 transition-all duration-4000 ease-smooth pointer-events-none">
